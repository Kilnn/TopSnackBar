...
import static com.kilnn.topsnackbar.AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR;

/**
 * Created by Kilnn on 2017/8/12.
 * Base class for lightweight transient bars that are displayed along the top edge of the
 * application window.
 *
 * @param <B> The transient top bar subclass.
 */
public abstract class BaseTransientTopBar<B extends BaseTransientTopBar<B>> {
    ...
    final TopSnackbarBaseLayout mView;
    ...
    protected BaseTransientTopBar(@NonNull ViewGroup parent, @NonNull View content,
        ...
        mView = (TopSnackbarBaseLayout) inflater.inflate(
                R.layout.layout_top_snackbar, mTargetParent, false);
    ...
    final void showView() {
        ...
        mView.setOnAttachStateChangeListener(
                new BaseTransientTopBar.OnAttachStateChangeListener() {
                    @Override
        ...
        if (ViewCompat.isLaidOut(mView)) {
            ...
            mView.setOnLayoutChangeListener(new BaseTransientTopBar.OnLayoutChangeListener() {
                @Override
    ...
    static class TopSnackbarBaseLayout extends FrameLayout {
        ...
        TopSnackbarBaseLayout(Context context) {
            this(context, null);
        }

        TopSnackbarBaseLayout(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SnackbarLayout);
            if (a.hasValue(R.styleable.TopSnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, a.getDimensionPixelSize(
                        R.styleable.TopSnackbarLayout_elevation, 0));
            }
            a.recycle();
    ...
    final class Behavior extends SwipeDismissBehavior<TopSnackbarBaseLayout> {
        @Override
        public boolean canSwipeDismissView(View child) {
            return child instanceof TopSnackbarBaseLayout;
        }

        @Override
        public boolean onInterceptTouchEvent(CoordinatorLayout parent, TopSnackbarBaseLayout child,
                                             MotionEvent event) {
